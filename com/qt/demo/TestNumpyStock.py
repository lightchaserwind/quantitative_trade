...
class TestNumpyStock(TestCase):
    ...
    def testMedian(self):
        ...
        print("end_price median:{}".format(np.median(end_price)))
        # end_price median:10.864999999999998
    ...
    def testVar(self):
        ...
        print("end_price variance:{}".format(np.var(end_price)))
        print("end_price variance:{}".format(end_price.var()))
        # end_price variance: 1.3352127499999997
        # end_price variance: 1.3352127499999997
